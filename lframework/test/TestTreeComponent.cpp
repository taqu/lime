    ...
    TEST_CASE("TestTreeComponent")
    {
        ...
        SECTION("Create")
        {
            ...
            for(s32 i=0; i<Size; ++i){
                ...
                EXPECT_STR_EQ(name[i], componentLogical->getName().c_str());
            ...
            for(s32 i=0; i<ChildSize; ++i){
                ...
                EXPECT_TRUE(NULL != componentLogical);
                EXPECT_STR_EQ(childName[i], componentLogical->getName().c_str());
            }
                ...
                ++itr)
            {
                ...
                EXPECT_EQ(0, componentLogical->getNumChildren());
                EXPECT_STR_EQ(childName[count], componentLogical->getName().c_str());
                ++count;
            }
