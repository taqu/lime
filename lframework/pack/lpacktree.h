#ifndef INC_LPACK_PACKTREE_H__
#define INC_LPACK_PACKTREE_H__
/**
@file lpacktree.h
@author t-sakai
...
namespace lpacktree
{
    ...
    public:
        ...
        const FileEntry* find(const Char* path) const;
    ...
    {
        return header_.numEntries_;
    }

    // エントリ取得
    inline const FileEntry& PackBase::getEntry(u32 index) const
    {
        LASSERT(0<=index && index<header_.numEntries_);
