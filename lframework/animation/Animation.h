#ifndef INC_LFRAMEWORK_ANIMATION_H__
#define INC_LFRAMEWORK_ANIMATION_H__
/**
@file Animation.h
@author t-sakai
...
namespace lfw
{
    ...
    public:
        ...
        void setClip(s16 index, AnimationClip::pointer& clip);
...
#endif //INC_LFRAMEWORK_ANIMATION_H__
