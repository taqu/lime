#ifndef INC_LSCENE_LANIM_ANIMATIONCONTROLERPARTIAL_H__
#define INC_LSCENE_LANIM_ANIMATIONCONTROLERPARTIAL_H__
/**
...
namespace lanim
{
    ...
    */
    ...
    public:
        ...
        typedef lcore::vector_arena<JointMap, lcore::DefaultAllocator, lcore::vector_arena_static_inc_size<4> > JointMapVector;
    ...
    // フラグセット取得
    inline const Flags& AnimationControlerPartial::getFlags() const
    {
        return flags_;
    }

    // フラグセット取得
    inline Flags& AnimationControlerPartial::getFlags()
    {
        return flags_;
    }
...
#endif //INC_LSCENE_LANIM_ANIMATIONCONTROLERPARTIAL_H__
