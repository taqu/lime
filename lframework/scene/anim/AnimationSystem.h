#ifndef INC_LSCENE_LANIM_ANIMATIONSYSTEM_H__
#define INC_LSCENE_LANIM_ANIMATIONSYSTEM_H__
/**
...
namespace lanim
{
    ...
    */
    ...
    private:
        ...
        typedef lcore::vector_arena<AnimationControler*, lcore::DefaultAllocator, lcore::vector_arena_static_inc_size<8> > AnimCtrlVector;
...
#endif // INC_LSCENE_LANIM_ANIMATIONSYSTEM_H__
