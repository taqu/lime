...
*/
#include "geometry/DepthCluster.h"
...
namespace lmath
{
    ...
    DepthCluster::DepthCluster(s32 capacity)
        ...
        ,size_(0)
    {
        vertices_ = (Vertex*)LALIGNED_MALLOC(capacity_*sizeof(Vertex), Align);
    }

    DepthCluster::~DepthCluster()
    {
        LALIGNED_FREE(vertices_, Align);
    }
    ...
    void DepthCluster::resize()
    {
        ...
        Vertex* vertices = (Vertex*)LALIGNED_MALLOC(capacity_*sizeof(Vertex), Align);
