...
namespace lcore
{
        ...
        :treeMap_(0)
    {
        for(u32 i=0; i<NumTreeBins; ++i){
            ...
            LASSERT(lcore::mostSiginificantBit(treeBins_[i].getSize()) == i);
        }
    }
    ...
    inline MemoryAllocator::index_type MemoryAllocator::BitwiseTrie::getBinIndex(size_type size)
    {
        ...
        return lcore::mostSiginificantBit(size);
    }
    ...
    {
        {
            ...
            systemInfo.dwPageSize = PageBankSize;
...
COMBINE_NEXT:
    ...
    MemoryAllocator::PageBank* MemoryAllocator::createPageBank()
    {
        ...
        PageBank* pageBank = (PageBank*)LIME_MALLOC(PageBankSize);
        pageBank->next_ = NULL;
