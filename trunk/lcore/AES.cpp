...
s32 AES::encrypt(AESContext& context, u8* cipher, const u8* data, s32 dataLength)
{
    LASSERT(NULL != cipher);
    LASSERT(NULL != data);
    LASSERT(0 == (dataLength & 0xFU));
...
s32 AES::decrypt(AESContext& context, u8* data, const u8* cipher, s32 cipherLength)
{
    LASSERT(NULL != data);
    LASSERT(NULL != cipher);
    LASSERT(0 == (cipherLength & 0xFU));
    LASSERT(context.isInitialized());
