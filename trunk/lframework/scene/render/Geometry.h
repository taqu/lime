#ifndef INC_LSCENE_LRENDER_GEOMETRY_H__
#define INC_LSCENE_LRENDER_GEOMETRY_H__
/**
@file Geometry.h
@author t-sakai
...
namespace lrender
{
    ...
    public:
        ...
        inline void attach(lgraphics::ContextRef& context);
    ...
    inline void Geometry::attach(lgraphics::ContextRef& context)
    {
        inputLayout_.attach(context);
        vb_.attach(context, 0, vsize_, 0);
        ib_.attach(context, lgraphics::Data_R16_UInt, 0);
    }
...
#endif //INC_LSCENE_LRENDER_GEOMETRY_H__
