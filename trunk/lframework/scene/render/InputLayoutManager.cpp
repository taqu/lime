...
namespace lrender
{
    InputLayoutManager* InputLayoutManager::instance_ = NULL;

    void InputLayoutManager::initialize()
    {
        if(NULL == instance_){
            instance_ = LSCENE_NEW InputLayoutManager;
        }
    }
    ...
    bool InputLayoutManager::add(s32 id, lgraphics::InputLayoutRef& layoutRef)
    {
    ...
    lgraphics::InputLayoutRef* InputLayoutManager::find(s32 id)
    {
