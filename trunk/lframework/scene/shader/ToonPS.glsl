...
"    vec3 power = min(dlColor.xyz * diffuse.xyz + ambient, c_fone);\n"
"    color.xyz = (color.xyz * c) * power + dlColor.xyz*v_specular0.xyz;\n"
"#else\n"
"    vec3 power = min(dlColor.xyz * diffuse.xyz + ambient, c_fone);\n"
"    color.xyz = (color.xyz * v_specular0.w) * power + dlColor.xyz*v_specular0.xyz;\n"
"#endif //TEXSHADE\n"
