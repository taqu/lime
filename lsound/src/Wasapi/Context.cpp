...
#define LSOUND_DECL_STOP(str)
    ...
    u32 __stdcall Context::proc(void* args)
    {
        ...
        if(!context->createDevice()){
            ...
            CoUninitialize();
            _endthreadex(static_cast<u32>(-1));
            return 0;
        }
    ...
    bool Context::initialize(const InitParam& initParam)
    {
        ...
        instance_ = LNEW Context(initParam);
    ...
    {
        LDELETE_ARRAY(userPlayers_);
        LDELETE_ARRAY(players_);
    ...
    void Context::initStreams()
    {
        ...
        u32 elemSize = static_cast<u32>(lcore::maximum(sizeof(FileStream), sizeof(MemoryStream)));
        u8* buffer = (u8*)LMALLOC(elemSize * initParam_.maxPlayers_);
    ...
    void Context::initPlayers()
    {
        ...
        players_ = LNEW Player[initParam_.maxPlayers_];
    ...
    void Context::initUserPlayers()
    {
        ...
        userPlayers_ = LNEW UserPlayer[initParam_.maxUserPlayers_];
