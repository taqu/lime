...
namespace lsound
{
    ...
    bool Player::create(s32 numBuffers, IAudioClient* audioClient, const WAVEFORMATEX& fmt)
    {
    ...
    void Player::setStream(Stream* stream)
    {
        ...
        resampler_.setSource(static_cast<u16>(stream_->getChannels()), static_cast<u16>(stream_->getBitsPerSample()>>3), stream_->getSampleRate());
