...
APP_C_INCLUDES := $(APP_PROJECT_PATH)../../ $(APP_PROJECT_PATH)../../ext/arm/include/ $(APP_PROJECT_PATH)../../ext/include/ $(APP_PROJECT_PATH)../../ext/include/bullet/ ../lib/anim/ ../tools/libConverter/ ../lib/dynamics/
