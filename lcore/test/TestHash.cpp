...
namespace lcore
{
    TEST_CASE("TestHash::TestXXHashSpecialized")
    {
    ...
    TEST_CASE("TestHash::CollisionNumbers32")
    {
#ifdef _DEBUG
        ...
        LOG_INFO("num of samples: " << numbers.size());
        ...
        LOG_INFO("Murmur3  : " <<  colMurmur);
        LOG_INFO("xxHash   : " <<  colXX);
        LOG_INFO("FNV1     : " <<  colFnv);
        //std::cerr << "Bernstein: " <<  colBern << std::endl;
    }

    TEST_CASE("TestHash::CollisionNumbers64")
    {
#ifdef _DEBUG
        static const s32 NumSamples = 1000;
#else
    ...
    TEST_CASE("TestHash::CollisionString")
    {
#ifdef _DEBUG
        ...
        LOG_INFO("num of samples: " << strings.size());
    ...
    TEST_CASE("TestHash::SpeedNumber")
    {
        ...
        LOG_INFO("Murmur3  : " <<  timeMurmur);
        LOG_INFO("xxHash   : " <<  timeXX);
        LOG_INFO("FNV1     : " <<  timeFNV);
        //std::cerr << "Bernstein: " <<  timeBern << std::endl;
    }

    TEST_CASE("TestHash::SpeedString")
    {
