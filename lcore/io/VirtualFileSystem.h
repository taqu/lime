#ifndef INC_LCORE_VIRTUALFILESYSTEM_H__
#define INC_LCORE_VIRTUALFILESYSTEM_H__
/**
...
namespace lcore
{
    ...
    public:
        ...
        virtual s64 read(s64 offset, s64 size, u8* buffer) const =0;
        virtual s64 write(s64 offset, s64 size, u8* data) =0; 
    ...
    //---
    //----------------------------------------------------------
    class FileProxyIStream : lcore::istream
    {
    public:
        FileProxyIStream();
    ...
    protected:
        FileProxyIStream(const FileProxyIStream&);
        FileProxyIStream& operator=(const FileProxyIStream&);
    ...
    {
        return sizeof(T) == read(&dst, sizeof(T));
    }
