#ifndef INC_LIOFWD_H__
#define INC_LIOFWD_H__
/**
@file liofwd.h
@author t-sakai
...
namespace lcore
{
    ...
    public:
        ...
        virtual void read(char* dst, u32 count) =0;
    ...
    public:
        ...
        virtual void write(const char* src, u32 count) =0;
    protected:
        ostream(){}
        ~ostream(){}
    ...
    protected:
        ...
        virtual void read(char* dst, u32 count);
        virtual void write(const char* src, u32 count);
    ...
    template<class Base>
    inline void fstream_base<Base>::read(char* dst, u32 count)
    {
        LASSERT(file_ != NULL);
        fread((void*)dst, count, 1, file_);
    }

    template<class Base>
    inline void fstream_base<Base>::write(const char* src, u32 count)
    {
        fwrite((void*)src, count, 1, file_);
    }
    ...
    public:
        ...
        virtual void read(char* dst, u32 count){super_type::read(dst, count);}
    ...
    public:
        ...
        virtual void write(const char* src, u32 count){super_type::write(src, count);}
    ...
    template<class Base>
    void sstream_base<Base>::read(char* dst, u32 count)
    {
    ...
    template<class Base>
    void sstream_base<Base>::write(const char* src, u32 count)
    {
        s32 end = current_ + count;
        if(end > capacity_){
            expand();
    ...
    protected:
        ...
        virtual void read(char* dst, u32 count);
        virtual void write(const char* /*src*/, u32 /*count*/){}; //何もしない
...
{
    template<class T>
    inline void write(lcore::ostream& of, const T& value)
    {
        of.write(reinterpret_cast<const char*>(&value), sizeof(T));
    }

    template<class T>
    inline void write(lcore::ostream& of, const T* value, u32 size)
    {
        of.write(reinterpret_cast<const char*>(value), size);
    }

    template<class T>
    inline void read(lcore::istream& in, T& value)
    {
        in.read(reinterpret_cast<char*>(&value), sizeof(T));
    }

    template<class T>
    inline void read(lcore::istream& in, T* value, u32 size)
    {
        in.read(reinterpret_cast<char*>(value), size);
    }
}
}
#endif //INC_LIOFWD_H__
