...
#define LRENDER_BINQBVH_SSEPACK (1)
    ...
    public:
        ...
        lmath::Result intersectBoth(Intersection& intersection, const Ray& ray) const;
        lmath::Result intersectBoth(const Ray& ray) const;
    ...
    private:
        ...
        typedef lcore::Array<f32> F32Vector;
        typedef lcore::Array<AABB> AABBVector;

        lcore::Array<const Shape*> shapes_;
        lcore::Array<Node, lcore::array_static_inc_size<16>, Align16Allocator> nodes_;
