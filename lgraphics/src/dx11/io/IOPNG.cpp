...
namespace io
{
    ...
    {
        ColorType colorType;
        if(!cppimg::PNG::read(width, height, colorType, buffer, is)){
            return false;
        }
    ...
    {
        ColorType colorType;
        bool result = cppimg::PNG::read(width, height, colorType, NULL, is);
        if(!result){
            return false;
        }
        switch(colorType){
        ...
        result = cppimg::PNG::read(width, height, colorType, buffer, is);
        if(!result){
