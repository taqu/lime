...
namespace lrender
{
    ...
    void LowDiscrepancySampler::generate1D(lcore::RandomWELL& random, f32* samples, s32 size)
    {
    ...
    void LowDiscrepancySampler::generate2D(lcore::RandomWELL& random, Sample2D* samples, s32 size)
    {
    ...
    {
        LowDiscrepancySampler* sampler = LIME_NEW LowDiscrepancySampler(numSamples_, random_.rand(), numDimensions_);
