...
namespace lrender
{
    ...
    private:
        ...
        void generate1D(lcore::RandomWELL& random, f32* samples, s32 size);
        void generate1D(lcore::RandomWELL& random, f32* samples, s32 numSamples, s32 size);
        void generate2D(lcore::RandomWELL& random, Sample2D* samples, s32 size);
        void generate2D(lcore::RandomWELL& random, Sample2D* samples, s32 numSamples, s32 size);
